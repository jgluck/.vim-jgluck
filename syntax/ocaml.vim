...
syn keyword  ocamlKeyword  land lazy let
syn keyword  ocamlKeyword  method mutable new of
"syn keyword  ocamlKeyword  parser private raise rec
syn keyword  ocamlKeyword  parser private raise
syn keyword  ocamlKeyword  try type
"syn keyword  ocamlKeyword  val virtual when while with
syn keyword  ocamlKeyword  val virtual when while
syn keyword  ocamlLet      let rec
syn keyword  ocamlMatchWith  match with
syn keyword  ocamlEval     eval
