...
syn region pythonString		start=+"+ skip=+\\\\\|\\"\|\\$+ excludenl end=+"+ end=+$+ keepend contains=pythonEscape,pythonEscapeError,@Spell
" MEGNOTE changed String to Comment in next 2 lines
syn region pythonBlockComment		start=+"""+ end=+"""+ keepend contains=pythonEscape,pythonEscapeError,pythonDocTest2,pythonSpaceError,@Spell
syn region pythonBlockComment		start=+'''+ end=+'''+ keepend contains=pythonEscape,pythonEscapeError,pythonDocTest,pythonSpaceError,@Spell
...
if version >= 508 || !exists("did_python_syn_inits")
  ...
  HiLink pythonComment		Comment
	HiLink pythonBlockComment	Comment
